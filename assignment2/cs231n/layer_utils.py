...
def affine_batch_norm_relu_forward(x, w, b, gamma, beta, bn_param):
    """
    Convenience layer that perorms an affine transform, Batch normalization followed by a ReLU
    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    Returns a tuple of:
...
def affine_batch_norm_relu_backward(dout, cache):
    """
    Backward pass for the relu-batch_norm-affine convenience layer
    """
...
def conv_batch_norm_relu_forward(x, w, b, gamma, beta, conv_param, bn_param):
    """
    Convenience layer that perorms an affine transform, Batch normalization followed by a ReLU
    Inputs:
    - x: Input to the affine layer
...
def conv_batch_norm_relu_pool_forward(x, w, b, gamma, beta, conv_param, bn_param, pool_param):
    """
    Convenience layer that perorms an affine transform, Batch normalization, ReLU followed by a Max Pool
    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    Returns a tuple of:
    ...
    out, pool_cache = max_pool_forward_fast(out_relu, pool_param)
    cache = (conv_cache, batch_cache, relu_cache, pool_cache)
    return out, cache

def conv_batch_norm_relu_backward(dout, cache):
    """
    Backward pass for the relu-batch_norm-affine convenience layer
    """
...
def conv_batch_norm_relu_pool_backward(dout, cache):
    """
    Backward pass for the pool-relu-batch_norm-affine convenience layer
    """
